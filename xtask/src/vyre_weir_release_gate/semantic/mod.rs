...
pub(super) fn run_semantic_requirement_checks(
    ...
    match requirement.id.as_str() {
        ...
        "c-parser-linux-subsystem" => c_parser_linux_subsystem::check(requirement, base_dir, failures),
        ...
        "distributed-parser-coherence" => distributed_parser_coherence::check(requirement, base_dir, failures),
        ...
        "optimization-benchmark-proof" => optimization_integration::check(requirement, base_dir, failures),
        "optimization-corpus-4096" => optimization_corpus_4096::check(requirement, base_dir, failures),
        ...
        "weir-analysis-integration" => weir_analysis_integration::check(requirement, base_dir, failures),
