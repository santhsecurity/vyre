...
- Added packed-`U8` line indexing and UTF-8 validation for text scans, fixed CUDA/PTX byte and halfword memory ops, and covered the paths with generated reference parity plus live CUDA boundary matrices.
