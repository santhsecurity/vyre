...
// fixpoint convergence semantics.
//
// GPU acquisition: none  -  every assertion uses CPU reference oracles.

// Inner cfg attributes were moved to the parent
// `adversarial_graph_reachability_fixpoint.rs` because they cannot
// ride an `include!`-d chunk.
