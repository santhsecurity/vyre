...
- Vyre release: `0.4.2`
- Weir release: `0.1.0`
- Required version-matrix packages: `vyre@0.4.2`, `vyre-driver-cuda@0.4.2`, `vyre-driver-wgpu@0.4.2`, `vyrec@0.1.0`, `vyre-frontend-c@0.4.2`, and `weir@0.1.0`; `missing_required_release_packages` must be empty.
...
- Vyre RC tag: `vyre-v0.4.2-rc.1`
- Weir RC tag: `weir-v0.1.0-rc.1`
- Combined release-train RC tag: `vyre-0.4.2-weir-0.1.0-rc.1`
- Vyre tag: `vyre-v0.4.2`
- Weir tag: `weir-v0.1.0`
- Combined release-train tag: `vyre-0.4.2-weir-0.1.0`
...
- Release notes must name `vyre 0.4.2`.
- Release notes must name `weir 0.1.0`.
- Release notes must preserve the required package story: `vyre`, `vyrec`, and `vyre-frontend-c` ship on the `0.4.2` Vyre train, while `weir` ships as `0.1.0`.
- Release notes must name `vyre-v0.4.2-rc.1`.
- Release notes must name `weir-v0.1.0-rc.1`.
- Release notes must name `vyre-0.4.2-weir-0.1.0-rc.1`.
- Release notes must name `vyre-v0.4.2`.
- Release notes must name `weir-v0.1.0`.
- Release notes must name `vyre-0.4.2-weir-0.1.0`.
- Release notes must not instruct maintainers to create or push a bare `v0.4.2` tag for this release train.
