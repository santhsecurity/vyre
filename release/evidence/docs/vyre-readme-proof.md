...
- `vyre-readme-contracts.json` must prove release-specific tokens for `0.4.1`, CUDA, WGPU, GPU requirements, bytecode conditions, `vyre::Program`, concrete evidence paths, and at least one example block.
